...
var config = {
  apiOrigins: {
    production: 'https://enigmatic-wildwood-15287.herokuapp.com',
...
var app_api = __webpack_require__(17);
var app_ui = __webpack_require__(18);
...
var randomBeverageOnLoad = function randomBeverageOnLoad(event) {
  // console.log('randomBeverageOnLoad called')
  app_api.getRandomCoctail().then(app_ui.getRamdomBeverageSuccess).catch(app_ui.getRamdomBeverageFailure);
};

var searchTheCoctailDbByName = function searchTheCoctailDbByName(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log('searchTheCoctailDbByName called with data:', data)
  app_api.cockTailDbNameSearch(data).then(app_ui.getExternalBeverageSuccess).catch(app_ui.getExternalBeverageFailure);
};

// begin app events

var onAddBeverage = function onAddBeverage(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log('onAddBeverage called with data:', data)
  app_api.addBeverage(data).then(app_ui.addBeverageSuccess).catch(app_ui.addBeverageFailure);
};

var onViewAllBeverages = function onViewAllBeverages() {
  event.preventDefault();
  app_api.listAllBeverages().then(app_ui.viewAllBeveragesSuccess).catch(app_ui.viewAllBeveragesFailure);
};

var onViewMyBeverages = function onViewMyBeverages() {
  // console.log('onViewMyBeverages called')
  event.preventDefault();
  app_api.listAllUserBeverages().then(app_ui.viewMyBeveragesSuccess).catch(app_ui.viewMyBeveragesFailure);
};

var onDeleteBeverage = function onDeleteBeverage(event) {
  // console.log('onDeleteBeverage called')
  event.preventDefault();
  var data = $(event.target).attr('value');
  app_api.deleteBeverage(data).then(app_ui.deleteBeverageSuccess).catch(app_ui.deleteBeverageFailure);
};

var onViewBeverage = function onViewBeverage(event) {
  // console.log('onViewBeverage called')
  event.preventDefault();
  var data = $(event.target).attr('value');
  app_api.showUserBeverage(data).then(app_ui.showMyBeverageSuccess).catch(app_ui.showMyBeverageFailure);
};

var onUpdateBeverage = function onUpdateBeverage(event) {
  event.preventDefault();
  var data = getFormFields(this);
  // console.log('onUpdateBeverage called with data:', data)
  app_api.modifyBeverage(data).then(app_ui.modifyBeverageSuccess).catch(app_ui.modifyBeverageFailure);
};

// navigation bar button methods

var onGoAddBeverage = function onGoAddBeverage(event) {
  event.preventDefault();
  // console.log('onGoAddBeverage called')
  app_ui.goToAddBeverage();
};

var onGoAllBeverages = function onGoAllBeverages(event) {
  event.preventDefault();
  app_ui.goToAllBeverages();
};

var onGoMyBeverages = function onGoMyBeverages(event) {
  event.preventDefault();
  app_ui.goToMyBeverages();
};

var onGoToWelcome = function onGoToWelcome(event) {
  event.preventDefault();
  app_ui.goToWelcome();
};

var onHideChngePwForm = function onHideChngePwForm(event) {
...
module.exports = {
  ...
  notUniquePw: notUniquePw,
  pwDontMatch: pwDontMatch
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var config = __webpack_require__(3);
var store = __webpack_require__(4);
var cockTailDbName = 'https://www.thecocktaildb.com/api/json/v1/1/search.php?s=';
var randomCoctail = 'https://www.thecocktaildb.com/api/json/v1/1/random.php';

// search thecocktaildb.com

var cockTailDbNameSearch = function cockTailDbNameSearch(data) {
...
var getRandomCoctail = function getRandomCoctail() {
...
var listAllUserBeverages = function listAllUserBeverages() {
...
var listAllBeverages = function listAllBeverages() {
  // console.log('listAllBeverages called')
  return $.ajax({
...
var addBeverage = function addBeverage(data) {
...
var modifyBeverage = function modifyBeverage(data) {
  // console.log('app_api.modifyBeverage called: ', data.beverage.id)
  var beverageId = data.beverage.id;
  return $.ajax({
...
var deleteBeverage = function deleteBeverage(data) {
...
var showUserBeverage = function showUserBeverage(data) {
...
module.exports = {
  cockTailDbNameSearch: cockTailDbNameSearch,
  getRandomCoctail: getRandomCoctail,
  listAllUserBeverages: listAllUserBeverages,
  listAllBeverages: listAllBeverages,
  addBeverage: addBeverage,
  modifyBeverage: modifyBeverage,
  deleteBeverage: deleteBeverage,
  showUserBeverage: showUserBeverage
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var viewAllBeveragesTemplate = __webpack_require__(19);
var randomBeveragesTemplate = __webpack_require__(36);
var myBeveragesTemplate = __webpack_require__(37);

// external beverage db methods

var getRamdomBeverageSuccess = function getRamdomBeverageSuccess(data) {
  $('#messages').show().html('We hope you enjoy this beverage!').fadeOut(8000);
  // console.log('getRamdomBeverageSuccess data is:', data)
  var showRandomBevHtml = randomBeveragesTemplate({ drinks: data.drinks });
  $('#random_bev_target').append(showRandomBevHtml);
};

var getRamdomBeverageFailure = function getRamdomBeverageFailure(error) {
...
var getExternalBeverageSuccess = function getExternalBeverageSuccess(data) {
  // console.log('getRamdomBeverageSuccess data is:', data)
  var showExternalDBListHTML = randomBeveragesTemplate({ drinks: data.drinks });
  $('#search_externalDB_target').empty();
  $('#search_externalDB_target').append(showExternalDBListHTML);
};

var getExternalBeverageFailure = function getExternalBeverageFailure(error) {
...
// add beverage
var addBeverageSuccess = function addBeverageSuccess() {
  $('#messages').show().html('Beverage was added successfully').fadeOut(8000);
  $(':input', '#add_beverage_form').val('');
};
var addBeverageFailure = function addBeverageFailure(error) {
...
// list all beverages
var viewAllBeveragesSuccess = function viewAllBeveragesSuccess(data) {
  // console.log('viewAllBeveragesSuccess data is :', data)
  var showAllBevsHtml = viewAllBeveragesTemplate({ beverages: data.beverages });
  $('#all_beverages_target').empty();
  $('#all_beverages_target').append(showAllBevsHtml);
};

var viewAllBeveragesFailure = function viewAllBeveragesFailure(error) {
...
// list my_beverages
var viewMyBeveragesSuccess = function viewMyBeveragesSuccess(data) {
  var showMyBevsHtml = myBeveragesTemplate({ beverages: data.beverages });
  $('#my_beverages_target').empty();
  $('#my_beverages_target').append(showMyBevsHtml);
};

var viewMyBeveragesFailure = function viewMyBeveragesFailure(error) {
  console.error('listAllBeverages failed: ', error);
...
var deleteBeverageSuccess = function deleteBeverageSuccess() {
  $('#messages').show().html('Beverage deleted successfully').fadeOut(8000);
};

var deleteBeverageFailure = function deleteBeverageFailure(error) {
  console.error('deleteBeverage failed: ', error);
  $('#messages').show().html('There was a problem deleting the beverage.').fadeOut(8000);
};

// show my beverage
var showMyBeverageSuccess = function showMyBeverageSuccess(data) {
...
var showMyBeverageFailure = function showMyBeverageFailure(error) {
...
var modifyBeverageSuccess = function modifyBeverageSuccess() {
...
var modifyBeverageFailure = function modifyBeverageFailure(error) {
...
var goToAddBeverage = function goToAddBeverage() {
  $('#all_beverages_panel').hide();
  $('#my_beverages_panel').hide();
  $('#welcome_panel').hide();
...
var goToAllBeverages = function goToAllBeverages() {
  $('#my_beverages_panel').hide();
...
var goToMyBeverages = function goToMyBeverages() {
  $('#add_beverage_panel').hide();
  $('#all_beverages_panel').hide();
  $('#welcome_panel').hide();
...
var goToWelcome = function goToWelcome() {
  $('#add_beverage_panel').hide();
  $('#all_beverages_panel').hide();
  $('#my_beverages_panel').hide();
  $('#welcome_panel').show();
...
var hideChngePwForm = function hideChngePwForm() {
  $(':input', '#change-password').val('');
  $('#change_pw').collapse('hide');
};

module.exports = {
  getRamdomBeverageSuccess: getRamdomBeverageSuccess,
  getRamdomBeverageFailure: getRamdomBeverageFailure,
  getExternalBeverageSuccess: getExternalBeverageSuccess,
  getExternalBeverageFailure: getExternalBeverageFailure,
  addBeverageSuccess: addBeverageSuccess,
  addBeverageFailure: addBeverageFailure,
  viewAllBeveragesSuccess: viewAllBeveragesSuccess,
  viewAllBeveragesFailure: viewAllBeveragesFailure,
  viewMyBeveragesSuccess: viewMyBeveragesSuccess,
  viewMyBeveragesFailure: viewMyBeveragesFailure,
  deleteBeverageSuccess: deleteBeverageSuccess,
  deleteBeverageFailure: deleteBeverageFailure,
  showMyBeverageSuccess: showMyBeverageSuccess,
  showMyBeverageFailure: showMyBeverageFailure,
  modifyBeverageSuccess: modifyBeverageSuccess,
  modifyBeverageFailure: modifyBeverageFailure,
  goToAddBeverage: goToAddBeverage,
  goToAllBeverages: goToAllBeverages,
  goToMyBeverages: goToMyBeverages,
  goToWelcome: goToWelcome,
  hideChngePwForm: hideChngePwForm
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <tr data-id=\""
    ...
    + "</td>\n          <td align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.recipe : stack1), depth0))
    + "</td>\n          <td align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.instructions : stack1), depth0))
    + "</td>\n        </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    There are no beverages on record.\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.beverages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <tr data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.idDrink : stack1), depth0))
    + "\">\n          <td valign=\"top\" align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strDrink : stack1), depth0))
    + "</td>\n          <td valign=\"top\" align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strAlcoholic : stack1), depth0))
    + "</td>\n          <td valign=\"top\" align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strCategory : stack1), depth0))
    + "</td>\n          <td valign=\"top\" align=\"left\">\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure1 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient1 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure2 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient2 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure3 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient3 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure4 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient4 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure5 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient5 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure6 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient6 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure7 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient7 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure8 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient8 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure9 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient9 : stack1), depth0))
    + "<br>\n            "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strMeasure10 : stack1), depth0))
    + " "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strIngredient10 : stack1), depth0))
    + "\n          </td>\n          <td valign=\"top\" align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.strInstructions : stack1), depth0))
    + "</td>\n        </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    <p>We are unable to connect to <a href=\"https://www.thecoctaildb.com\">The Coctail DB</a> to get your request.  Please try again later.</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.drinks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <tr data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.description : stack1), depth0))
    + "</td>\n          <td align=\"left\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.occasion : stack1), depth0))
    + "</td>\n          <td><button id=\"viewBvgBttn\" value=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" name='view' type='click'>View</button></td>\n          <td><button id=\"delBvgBttn\" value=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" name='delete' type='click'>Delete</button></td>\n        </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    There are no beverages on record.\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
